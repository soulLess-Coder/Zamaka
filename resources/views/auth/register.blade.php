...
<div class="items-center justify-center sm:flex sm:h-screen">
    <div class="grid grid-cols-1 m-10 sm:grid-cols-2 ">
      ...
      <div class="pt-6 ">
        ...
        <input type="text" id="Street" placeholder="@" class="w-full h-1 p-4 mt-2 transform bg-gray-200 border-2 rounded-xl shadow-lg hover:translate-x-1 hover:border-gray-100" />
      </div>
      ...
      <div class="pt-6">
        ...
        <input type="text" id="Street" placeholder="@" class="flex justify-center w-full h-1 p-4 mt-2 transform bg-gray-200 border-2 rounded-xl shadow-lg hover:translate-x-1 hover:border-gray-100" />
      </div>
