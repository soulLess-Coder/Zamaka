        ...
        <form method="post" action="{{route('register')}}">
            ...
            <div class="" >
                ...
                <div class="pt-6">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Confirm your password" class="flex w-1/2 h-5 p-4 mt-2 ml-10 text-red-300 transform border-2 shadow-lg rounded-xl bg-neutral-400 hover:translate-x-1 hover:border-gray-100" />
                ...
                <div class="pt-6">
                    ...
                    <input type="email" name="email" id="email" placeholder="Your Email" class="justify-center w-1/2 h-3 p-4 mt-2 ml-10 text-red-300 transform border-2 shadow-lg rounded-xl bg-neutral-400 hover:translate-x-1 hover:border-gray-100" />
                    @error('email')
                        <div class="mt-2 text-sm text-red-500">
                            {{ $message }}
                        </div>
                ...
                <div class="pt-6">
                    ...
                    <input type="text" name="phone_number" id="phone_number" placeholder="03-xxx-xxxx-xx" class="justify-center w-1/2 h-3 p-4 mt-2 ml-10 text-red-300 transform border-2 shadow-lg rounded-xl bg-neutral-400 hover:translate-x-1 hover:border-gray-100" />
                    @error('email')
                        <div class="mt-2 text-sm text-red-500">
                            {{ $message }}
                        </div>
