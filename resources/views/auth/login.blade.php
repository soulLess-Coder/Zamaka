...
<form action="{{ route('login') }}" method="post" class="grid grid-cols-1 bg-white sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2">
    ...
    <div class="hidden lg:block">
        <div class="justify-center flex"><a class="mx-auto"><img src="./images/lock1.png" /></a></div>
    </div>
    <div class="text-center text-left mix-blend-multiply bg-green-300 lg:bg-white lg:from-white lg:to-white md:bg-white md:from-white md:to-white ">
      <div class="flex justify-center">
        <div class="rounded-lg">
          <p class="text-center text-2xl"><b>Sign In</b></p>
          <br />
          <div class="mb-4">
            <label for="email" class="text-center block font-bold">Email</label>
          ...
          <br />
          <div class="mb-4">
            <label for="password" class="text-center block font-bold">Password</label>
