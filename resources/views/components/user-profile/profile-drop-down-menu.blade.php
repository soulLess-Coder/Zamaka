<div class="absolute right-0 z-20 w-40 py-2 mt-3 text-gray-500 bg-white rounded shadow-md menu md:mt-6 md:w-1/3 border-2 animated faster fadeIn hidden" id="drop-down">
    <!-- item -->
    ...
    <!-- item -->
    <a class="block px-4 py-2 text-sm font-medium tracking-wide capitalize transition-all duration-300 ease-in-out bg-white hover:bg-gray-200 hover:text-gray-900" href="{{ route('forgetpassword') }}">
