<div class="absolute right-0 z-20 hidden w-40 py-2 mt-3 text-gray-500 bg-white border-2 rounded shadow-md menu md:mt-6 md:w-1/3 animated faster fadeIn" id="drop-down">
    ...
    <a class="block px-4 py-2 text-sm font-medium tracking-wide capitalize transition-all duration-300 ease-in-out bg-white hover:bg-gray-200 hover:text-gray-900" href="{{ route('/tenant/request') }}">
        <i class="mr-1 text-xs fad fa-inbox-in"></i>
        House Detail
    </a>
    <!-- end item -->
