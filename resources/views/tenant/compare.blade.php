...
@section('content')
<div>
    <form action="{{ route('login') }}" method="post" class="grid grid-cols-2 bg-white sm:grid-cols-2 sm:grid-gap md:grid-cols-2 lg:grid-cols-2">
        <div class="p-5">
              <div class="flex justify-center">
                ...
                <br />
                <div class="mb-4">
                    <div class="w-auto row-span-6 p-5 sm:bg-white h-25 ">
                        <img src="./images/house.png" />
                    </div>
                <label for="password" class="block font-bold ">Price</label>
                <input  class="border-black border-2 w-25 h-5 p-4 @error('password') border-red-500 @enderror" value="" /></div>
              <div class="mb-4">
