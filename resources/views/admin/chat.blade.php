                ...
                <ul class="overflow-auto h-[32rem]">
                  ...
                  <li>
                    <a
                      ...
                      <div class="w-full pb-2">
                        <div class="flex justify-between">
                          <span class="block ml-2 font-semibold text-gray-600">Hassnain Ali</span>
                    ...
                    <a
                      ...
                      <div class="w-full pb-2">
                        <div class="flex justify-between">
                          <span class="block ml-2 font-semibold text-gray-600">Ammar</span>
                    ...
                    <a
                      ...
                      <div class="w-full pb-2">
                        <div class="flex justify-between">
                          <span class="block ml-2 font-semibold text-gray-600">Mahad</span>
              ...
              <div class="hidden lg:col-span-2 lg:block">
                <div class="w-full">
                  <div class="relative flex items-center p-3 border-b border-gray-300">
                    ...
                    <span class="block ml-2 font-bold text-gray-600">Mahad</span>
                  ...
                  <div class="relative w-full p-6 overflow-y-auto h-[40rem]">
                    <ul class="space-y-2">
                      ...
                      <li class="flex justify-start">
                        <div class="relative max-w-xl px-4 py-2 text-gray-700 rounded shadow">
                          <span class="block">I am fine. How are you?
                          </span>
                        </div>
                      </li>
                    </ul>
