                    ...
                    <table class="w-full whitespace-nowrap">
                        <thead>
                            <tr class="bg-gray-50 h-16 w-full text-sm leading-none text-gray-800">
                                ...
                                <th tabindex="0" class="focus:outline-none font-normal text-left px-10 lg:px-6 xl:px-0">Poperty ID</th>
                                <th tabindex="0" class="focus:outline-none font-normal text-left px-10 lg:px-6 xl:px-0"></th>
                                <th tabindex="0" class="focus:outline-none font-normal text-left px-10 lg:px-6 xl:px-0">Agent</th>
                                <th tabindex="0" class="focus:outline-none font-normal text-left px-10 lg:px-6 xl:px-0">Order #</th>
                        ...
                        <tbody class="w-full">
                            <tr class="h-20 text-sm leading-none text-gray-800 border-b border-gray-100">
                                ...
                                <td class="px-10 lg:px-6 xl:px-0">
                                    <p tabindex="0" class="focus:outline-none underline text-blue-700">BK0191</p>
                                </td>
                                <td class="px-10 lg:px-6 xl:px-0">
                                    <div class="flex items-center justify-center w-20 h-6 bg-yellow-100 rounded-full">
                                        <p tabindex="0" class="focus:outline-none text-xs leading-3 text-yellow-700">Pending</p>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr class="h-20 text-sm leading-none text-gray-800 border-b border-gray-100">
                                ...
                                <td class="px-10 lg:px-6 xl:px-0">
                                    <div class="flex items-center justify-center w-20 h-6 bg-green-100 rounded-full">
                                        <p tabindex="0" class="focus:outline-none text-xs leading-3 text-green-700">Confirmed</p>
                                    </div>
                                </td>
                                <td></td>
                            </tr>
