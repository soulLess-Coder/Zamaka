    ...
    <div class="sm:px-6 w-full">
        ...
        <div class="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
            <div class="sm:flex items-center justify-between">
                ...
                <button onclick="window.location.href='/tenant/request'" class="focus:ring-2 focus:ring-offset-2 focus:ring-red-600 mt-4 sm:mt-0 inline-flex items-start justify-start px-6 py-3  bg-red-500 hover:bg- bg-red-700 focus:outline-none rounded">
